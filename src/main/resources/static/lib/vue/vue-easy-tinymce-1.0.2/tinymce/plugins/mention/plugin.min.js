...
(function (tinymce, $) {
    ...
    AutoComplete.prototype = {
        ...
        matcher: function (item) {
            return ~(item[this.options.queryBy].toLowerCase() + ' '
                + (item[this.options.labelBy] ? item[this.options.labelBy].toLowerCase() : '')).indexOf(this.query.toLowerCase());
        },
        ...
        render: function (item) {
            ...
            const label = item[this.options.labelBy];

            return '<li>' +
                '<a href="javascript:;"><span>' + item[this.options.queryBy] + '</span>' +
                `${label ? '<span class="rte-autocomplete-label">'+label+'</span>' : ''}`+
                '</a>' +
                '</li>';
        },
